...
function MemberAvatar({ name, avatar }: { name: string | null; avatar: string | null }) {
  ...
  return (
    <div className="size-7 shrink-0 rounded-full overflow-hidden bg-primary/15 flex items-center justify-center text-xs font-bold text-primary ring-1 ring-white">
      {avatar ? (
