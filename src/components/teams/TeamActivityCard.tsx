...
function MemberAvatar({ name, avatar }: { name: string | null; avatar: string | null }) {
  ...
  return (
    <div className="size-7 shrink-0 rounded-full overflow-hidden bg-indigo-200 flex items-center justify-center text-[10px] font-bold text-indigo-700 ring-1 ring-white">
      {avatar ? (
